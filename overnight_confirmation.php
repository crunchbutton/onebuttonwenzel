...
function load() {
	...
	if(readCookie("ordercredit") || true) {
		...
		form.innerHTML = form.innerHTML + 
		"<input name=\"item_name_" + googleCount + "\" type=\"hidden\"" +
		" value=\"OVERNIGHT Delivery To: " + readCookie("address") + "\"/>" +
	    ...
	    "<input name=\"item_price_" + googleCount + "\" type=\"hidden\" value=\"" + 20 + "\"/>" +
	    "<input name=\"item_currency_" + googleCount + "\" type=\"hidden\" value=\"USD\"/>"; 
		...
		"<input name=\"item_name_" + googleCount + "\" type=\"hidden\"" +
		" value=\"Instructions: \"/>" +
	    "<input name=\"item_description_" + googleCount + "\" type=\"hidden\" value=\"To be prepared by 3 PM\"/>" +
	    "<input name=\"item_quantity_" + googleCount + "\" type=\"hidden\" value=\"" + 1 + "\"/>" +
